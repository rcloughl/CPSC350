...
CREATE TABLE specificFlight(
	...
	pilot text,
	copilot text,
	primary key (day, airline, flightNum, AID),
...
insert into crew (crewID, pilot, copilot) values
	('#1', 'Suzie', 'Stan'),
	('#2', 'Suzie', null)
;

insert into specificFlight (day, airline, flightNum, AID, crewID, ticketsSold) values
	('2021-9-8', 'United', 735, '#5566', '#1', 132),
	('2021-9-17', 'AirBlue', 101, '#52982', '#2', 1)
;
